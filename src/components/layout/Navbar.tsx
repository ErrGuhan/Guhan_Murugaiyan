...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={cn(
          "fixed top-0 left-0 w-full z-50 px-3 sm:px-8 md:px-12 flex items-center justify-between transition-all duration-300",
          isDarkSection
            ? "bg-[#0B0B0F]/95 backdrop-blur-md border-b-[3px] border-black text-white py-2.5 sm:py-3 shadow-[0_4px_0px_#000000]"
            : isScrolled
            ? "bg-[#FFFDF7]/95 backdrop-blur-md border-b-[3px] border-black text-black py-2.5 sm:py-3 shadow-[0_4px_0px_#000000]"
            : "bg-transparent text-black py-3 sm:py-5"
        )}
      >
        {/* Left: Title / Logo */}
        <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
          ...
          >
            <div className="px-2 sm:px-2.5 py-1 bg-[#FFE600] text-black border-[2.5px] sm:border-[3px] border-black shadow-[2.5px_2.5px_0px_#000000] sm:shadow-[3px_3px_0px_#000000] font-display font-black text-lg sm:text-xl tracking-tight -rotate-2 group-hover:rotate-0 transition-transform">
              GUHAN
            </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          <button
            ...
            className="comic-btn px-2 sm:px-2.5 py-1.5 rounded-lg border-[2px] border-black bg-white text-black hover:bg-[#FFE600] flex items-center gap-1 sm:gap-1.5 text-xs font-mono font-black cursor-pointer shadow-[2px_2px_0px_#000000] min-h-[36px]"
          >
            {audioEnabled ? (
          ...
          <button
            ...
            className="comic-btn w-10 h-10 min-h-[40px] flex flex-col justify-center items-center gap-1.5 p-2 rounded-xl bg-[#FFE600] text-black md:hidden"
      ...
      <div
        ...
        className={cn(
          "fixed inset-0 bg-[#0B0B0F] text-white z-[99990] flex flex-col justify-between p-3.5 sm:p-8 md:p-12 overflow-y-auto no-scrollbar transition-all duration-300 bg-halftone-dark select-none",
          isMenuOpen
      ...
      >
        {/* Overlay Top Header */}
        <div className="flex items-center justify-between border-b-[3px] border-black pb-3 sm:pb-4 max-w-md w-full mx-auto">
          <div className="flex items-center gap-2 sm:gap-2.5">
            <div className="px-2.5 sm:px-3 py-1 bg-[#FFE600] text-black border-[2.5px] sm:border-[3px] border-black shadow-[2.5px_2.5px_0px_#000000] font-display font-black text-lg sm:text-xl -rotate-2">
              GUHAN
            </div>
            <div className="flex flex-col leading-none">
              <span className="text-[11px] sm:text-xs font-mono font-black tracking-widest text-[#FFE600] uppercase">
                {"// NAVIGATION"}
              </span>
              <span className="text-[8px] sm:text-[9px] font-mono text-neutral-400 font-bold uppercase mt-0.5">
          ...
          <button
            ...
            className="comic-btn px-2.5 sm:px-3 py-1.5 rounded-xl bg-[#FF2A55] text-white border-[2px] sm:border-[2.5px] border-black shadow-[2.5px_2.5px_0px_#000000] font-mono font-black text-xs flex items-center gap-1.5 hover:bg-[#FFE600] hover:text-black transition-colors min-h-[36px]"
        ...
        <div className="flex flex-col items-center justify-center flex-1 my-3 sm:my-5 space-y-2 sm:space-y-2.5 max-w-md w-full mx-auto">
          {navLinks.map((item, idx) => {
            ...
            return (
              <a
                ...
                className="comic-card w-full p-2.5 sm:p-3.5 rounded-2xl bg-[#14141E] text-white border-[2.5px] sm:border-[3px] border-black shadow-[3px_3px_0px_#000000] sm:shadow-[4px_4px_0px_#000000] flex items-center justify-between group hover:bg-[#FFE600] hover:text-black transition-all active:translate-x-0.5 active:translate-y-0.5 min-h-[56px]"
                style={{ transitionDelay: `${idx * 25}ms` }}
              >
                <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
                  {/* Category Icon Badge */}
                  <div
                    className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl border-[2px] border-black shadow-[2px_2px_0px_#000000] flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform"
                    style={{ backgroundColor: item.accent, color: "#000" }}
                  >
                    <IconComp className="w-4 sm:w-5 h-4 sm:h-5 stroke-[2.5]" />
                  </div>

                  {/* Title & Explanatory Subtitle */}
                  <div className="flex flex-col min-w-0 flex-1 pr-1">
                    <div className="flex items-baseline gap-1.5 sm:gap-2">
                      <span className="font-mono text-[11px] sm:text-xs font-black text-[#FFE600] group-hover:text-black">
                        {item.num}
                      </span>
                      <span className="font-display font-black text-xl sm:text-2xl tracking-tight uppercase leading-none">
                        {item.label}
                      </span>
                    </div>
                    <span className="text-[9px] sm:text-[10px] font-mono tracking-wider text-neutral-400 group-hover:text-black/80 font-bold uppercase mt-0.5 truncate">
                      {item.subtitle}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0 ml-1">
                  <span className="hidden sm:inline-block text-[9px] font-mono font-black px-2 py-0.5 rounded bg-black/70 text-[#FFE600] group-hover:bg-black group-hover:text-[#FFE600] border border-black uppercase tracking-wider">
                    {item.tag}
                  </span>
        ...
        <div className="w-full max-w-md mx-auto grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-2.5 pt-2.5 sm:pt-3 border-t-[3px] border-black text-xs font-mono pb-6 sm:pb-4">
          ...
          <div
            ...
            className="comic-card p-2 sm:p-2.5 rounded-xl bg-[#14141E] border-[2px] sm:border-[2.5px] border-black shadow-[2.5px_2.5px_0px_#000000] sm:shadow-[3px_3px_0px_#000000] flex items-center justify-between cursor-pointer hover:border-[#FFE600] group outline-none focus-visible:ring-2 focus-visible:ring-[#FFE600] min-h-[44px]"
          >
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1 pr-1">
              ...
              <div className="min-w-0 flex-1">
                <span className="text-[8px] sm:text-[9px] text-[#FFE600] font-black uppercase block leading-none">
                  EMAIL DISPATCH
                </span>
                <span className="text-white text-[10px] sm:text-[11px] font-bold truncate block mt-0.5">
                  mguhan6383@gmail.com
                </span>
              </div>
            </div>
            <span className="text-[8px] sm:text-[9px] font-mono font-black px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-white text-black border border-black flex-shrink-0 ml-1 group-hover:bg-[#FFE600]">
              {copied ? "COPIED!" : "COPY"}
            </span>
          </div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="comic-card p-2 sm:p-2.5 rounded-xl bg-[#14141E] border-[2px] sm:border-[2.5px] border-black shadow-[2.5px_2.5px_0px_#000000] sm:shadow-[3px_3px_0px_#000000] flex items-center justify-between hover:border-[#00F0FF] group min-h-[44px]"
          >
            <div className="flex items-center gap-2 sm:gap-2.5 min-w-0 flex-1 pr-1">
              ...
              <div className="min-w-0 flex-1">
                <span className="text-[8px] sm:text-[9px] text-[#00F0FF] font-black uppercase block leading-none">
                  LINKEDIN PROFILE
                </span>
                <span className="text-white text-[10px] sm:text-[11px] font-bold truncate block mt-0.5">
                  /in/guhanmurugaiyan
            ...
            <span className="text-[8px] sm:text-[9px] font-mono font-black px-1.5 sm:px-2 py-0.5 sm:py-1 rounded bg-[#00F0FF] text-black border border-black flex-shrink-0 ml-1 group-hover:bg-[#FFE600]">
              CONNECT
            </span>
          </a>
        </div>
